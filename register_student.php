...
<div class="container">
  <div class="col-lg-12">
    <form action="includes/register_student_inc.php" method="POST">
      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col">
            ...
            <input type="text" class="form-control" id="semestreInput" name="semestreInput" placeholder="Ingrese su semestre">
          </div>
          <div class="col">
      ...
      <button type="submit" name="submit" class="btn btn-outline-primary">Registrarse</button>
    </form>
  </div>
</div>
